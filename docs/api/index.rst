...
`Objects API`_          2.6.0 (
                        `Redoc <https://redocly.github.io/redoc/?url=https://raw.githubusercontent.com/maykinmedia/objects-api/3.6.2/src/objects/api/v2/openapi.yaml>`__,
                        `Swagger <https://petstore.swagger.io/?url=https://raw.githubusercontent.com/maykinmedia/objects-api/3.6.2/src/objects/api/v2/openapi.yaml>`__
                        )
======================  ==========================================
