...
Open Object is deployed as a collection of containers.
...
are provided in Open Object, or the health checks to implement in containers of third
party software typically used in an Open Object deployment. You can incorporate these in
...
.. _docker-compose.yml: https://github.com/maykinmedia/open-object/blob/master/docker-compose.yml
...
Open Object containers
======================

HTTP service
------------

The Open Object web service listens on port 8000 inside the container and accepts HTTP
